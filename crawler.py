...
def main():
    ...
    def copy_to_clipboard(df):
        pass  # No-op, handled by text area and HTML button below
    ...
    if mode == "Dynamic Frontier":
        ...
        if st.button("Start Dynamic Crawl"):
            ...
            try:
                ...
                st.text_area("CSV Data (copy below for Google Sheets)", csv_data, height=200, key="csv_text_area")
                ...
                st.markdown("""
                    ...
                    function copyCSV() {
                        ...
                        for (let label of labels) {
                            if (label.innerText.includes('CSV Data (copy below for Google Sheets)')) {
                                ta = label.parentElement.querySelector('textarea');
                                break;
                            }
                        }
                        if (ta) {
