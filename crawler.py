...
class URLChecker:
    def __init__(self, user_agent: str, concurrency: int, timeout: int, respect_robots: bool):
        ...
        self.stop_event = asyncio.Event()  # Event for stopping the crawl
        self.last_adjustment_time = datetime.now()
        self.adjustment_interval = 10  # Adjust concurrency every 10 seconds
    ...
    async def check_robots(self, url: str) -> bool:
        ...
        try:
            ...
            async with self.robots_semaphore:  # Limit concurrent fetches
